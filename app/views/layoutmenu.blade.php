<html>
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('vendor/AdminLTE-2.3.0/bootstrap/css/bootstrap.min.css') }}">
    <!-- Font Awesome -->
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css">
    <!-- Ionicons -->
    <link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
    <!-- DataTables -->
    <link rel="stylesheet" href="{{ asset('vendor/AdminLTE-2.3.0/plugins/datatables/dataTables.bootstrap.css') }}">
    <!-- Theme style -->
    <link rel="stylesheet" href="{{ asset('vendor/AdminLTE-2.3.0/dist/css/AdminLTE.min.css') }}">
  ...
  <body class0"hold-transition skin-blue sidebar-mini">
 ...
 <div class="wrapper">
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2014-2015 <a href="http://factuavirtual.com.bo">Factura Virtual</a>.</strong> Todos los derechos reservados.
      </footer>
