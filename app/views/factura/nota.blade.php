...
<table cellpadding="2" border="0">
    ...
    <tr>
        <td width="60" align="right"><b>Nº de Nota:</b></td>
        <td width="160">'.$numeroNota.'</td>
    </tr>
    
</table>
';
$pdf->writeHTMLCell($w=0, $h=0, $x='128', $y='32', $datosCliente, $border=0, $ln=1, $fill=0, $reseth=true, $align='left', $autopadding=true);
...
';
$pdf->writeHTMLCell($w=0, $h=0, $x='70', $y='32', $nameClient, $border=0, $ln=1, $fill=0, $reseth=true, $align='left', $autopadding=true);
...
$pdf->writeHTMLCell($w=0, $h=0, $x='125', $y='46', $preparadoPor, $border=0, $ln=1, $fill=0, $reseth=true, $align='left', $autopadding=true);
