...
<BR><BR>
    ...
    <div class="row" style="min-height:10px">
    	<div class="col-md-5" id="col_1">
			...
			{{ Former::text('client')->placeholder('Escriba nombre del cliente...')->raw()->addGroupClass('form-control client_select')->class('typeahead form-control') }}
			</div>						
		...
		<div class="col-md-3" id="col_2">
			{{ Former::number('discount')->label('Descuento')->data_bind("value: discount, valueUpdate: 'afterkeydown'")->append('%') }}
	...
	<div class="form-actions">
		...
		@if (Auth::user()->isPro() || true)
			<div data-bind="visible: !is_recurring()">
				{{Form::submit(trans("texts.save_invoice"),  ['class' => 'btn btn-large btn-success openbutton'], array('id' => 'saveButton', 'onclick' => 'onSaveClick()')) }}
				&nbsp;&nbsp;&nbsp;
